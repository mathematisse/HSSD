...
public class Big_Boss_Manager : MonoBehaviour
{
    ...
    void Spawn_Dog_Randomly()
    {
        ...
        var dog = Instantiate(Dog, pos + transform.position, Quaternion.identity, transform);
        dog.GetComponent<Dog_Manager>().player = player.transform;
    }
